...
final class MovieInfoColumnView: UIView {
    ...
    private func arrangedViewForTitleAndSubtitle(_ title: String, subtitle: String) -> UIView {
    ...
    private func titleViewForText(_ text: String) -> UIView {
        let label = UILabel()
        label.text = text
    ...
    private func subtitleViewForText(_ text: String) -> UIView {
        let label = UILabel()
        label.text = text
