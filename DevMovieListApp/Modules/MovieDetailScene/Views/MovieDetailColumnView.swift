...
final class MovieDetailColumnView: UIView {
    ...
    func addViewsToStackView() {
        ...
        stackView.addArrangedSubview(arrangedViewForTitleAndSubtitle("⭐️ Rating", subtitle: (String(movieModel.voteAverage ?? 0))))
        stackView.addArrangedSubview(UIView())
    }
